...
namespace FBE.Migrations
{
    ...
    [Migration("20220705071605_init11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FBE.Models.Akademik_Kadro", b =>
                {
                    ...
                    b.Property<int?>("EGorevIdEGorev_Id")
                        .HasColumnType("int");

                    b.Property<int?>("Ens_KuruluIdEns_Kurul_ID")
                        .HasColumnType("int");

                    b.Property<bool>("Enstitu")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("EGorevIdEGorev_Id");

                    b.HasIndex("Ens_KuruluIdEns_Kurul_ID");
            ...
            modelBuilder.Entity("FBE.Models.EYKUyeler", b =>
                {
                    ...
                    b.Property<int?>("Ens_GorevlerEGorev_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Ens_GorevlerEGorev_Id");
            ...
            modelBuilder.Entity("FBE.Models.EYK_ARA", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("EYKUyelereyk_uyeler_ID")
                        .HasColumnType("int");

                    b.Property<int?>("Ens_GorevlerEGorev_Id")
                        .HasColumnType("int");

                    b.Property<bool>("Enstitu_Kurulu")
                        .HasColumnType("bit");

                    b.Property<bool>("Enstitu_Yonetim_Kurulu")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("EYKUyelereyk_uyeler_ID");
            ...
            modelBuilder.Entity("FBE.Models.Ens_Kurulu", b =>
                {
                    b.Property<int>("Ens_Kurul_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("Ens_Kurul_ID");

                    b.ToTable("Ens_Kurulu");
                });
            ...
            modelBuilder.Entity("FBE.Models.FileKadro", b =>
                {
                    b.Property<int>("FileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("FilesKadroSicil_No")
                        .HasColumnType("int");

                    b.HasKey("FileId");

                    b.HasIndex("FilesKadroSicil_No");
            ...
            modelBuilder.Entity("FBE.Models.FileProgram", b =>
                {
                    b.Property<int>("FileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("FilesProgramProg_Id")
                        .HasColumnType("int");

                    b.HasKey("FileId");

                    b.HasIndex("FilesProgramProg_Id");

                    b.ToTable("FilePrograms");
                });
            ...
            modelBuilder.Entity("FBE.Models.ImageProgram", b =>
                {
                    b.Property<int>("ImageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("ProgramImageProg_Id")
                        .HasColumnType("int");

                    b.HasKey("ImageId");

                    b.HasIndex("ProgramImageProg_Id");

                    b.ToTable("ImagePrograms");
                });
            ...
            modelBuilder.Entity("FBE.Models.KadroImage", b =>
                {
                    b.Property<int>("ImageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("AkademikImageSicil_No")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AkademikImageSicil_No");

                    b.ToTable("KadroImages");
                });
            ...
            modelBuilder.Entity("FBE.Models.Program_Duzey", b =>
                {
                    ...
                    b.Property<string>("Prog_Duzey_En")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FBE.Models.Akademik_Kadro", b =>
                {
                    ...
                    b.HasOne("FBE.Models.Ens_Gorevler", "EGorevId")
                        .WithMany()
                        .HasForeignKey("EGorevIdEGorev_Id");

                    b.HasOne("FBE.Models.Ens_Kurulu", "Ens_KuruluId")
                        .WithMany()
                        .HasForeignKey("Ens_KuruluIdEns_Kurul_ID");
                    ...
                    b.Navigation("EGorevId");

                    b.Navigation("Ens_KuruluId");
            ...
            modelBuilder.Entity("FBE.Models.EYKUyeler", b =>
                {
                    ...
                    b.HasOne("FBE.Models.Ens_Gorevler", "Ens_Gorevler")
                        .WithMany()
                        .HasForeignKey("Ens_GorevlerEGorev_Id");
            ...
            modelBuilder.Entity("FBE.Models.EYK_ARA", b =>
                {
                    ...
                    b.HasOne("FBE.Models.EYKUyeler", "EYKUyeler")
                        .WithMany()
                        .HasForeignKey("EYKUyelereyk_uyeler_ID");
            ...
            modelBuilder.Entity("FBE.Models.FileKadro", b =>
                {
                    b.HasOne("FBE.Models.Akademik_Kadro", "FilesKadro")
                        .WithMany("Files")
                        .HasForeignKey("FilesKadroSicil_No");

                    b.Navigation("FilesKadro");
                });
            ...
            modelBuilder.Entity("FBE.Models.FileProgram", b =>
                {
                    b.HasOne("FBE.Models.Programs", "FilesProgram")
                        .WithMany("Files")
                        .HasForeignKey("FilesProgramProg_Id");

                    b.Navigation("FilesProgram");
                });
            ...
            modelBuilder.Entity("FBE.Models.ImageProgram", b =>
                {
                    b.HasOne("FBE.Models.Programs", "ProgramImage")
                        .WithMany("Image")
                        .HasForeignKey("ProgramImageProg_Id");

                    b.Navigation("ProgramImage");
                });

            modelBuilder.Entity("FBE.Models.ImageSlider", b =>
                {
                    b.HasOne("FBE.Models.Slider", "sliders")
                        .WithMany()
            ...
            modelBuilder.Entity("FBE.Models.KadroImage", b =>
                {
                    b.HasOne("FBE.Models.Akademik_Kadro", "AkademikImage")
                        .WithMany("Image")
                        .HasForeignKey("AkademikImageSicil_No");

                    b.Navigation("AkademikImage");
                });
